...
export interface Item {
    ...
    /** The icon shown when the item is open (swap mode only) */
    iconOpenElement: HTMLElement | null;
    /** The icon shown when the item is closed (swap mode only) */
    iconCloseElement: HTMLElement | null;
...
export interface GeneratorConfig {
    /** HTML string for the expand/collapse icon (default: "▼"). Used in rotate mode. */
    icon?: string;
    /** HTML string for the icon shown when the item is open (swap mode). When both iconOpen and iconClose are provided, swap mode is used instead of rotate. */
    iconOpen?: string;
    /** HTML string for the icon shown when the item is closed (swap mode). When both iconOpen and iconClose are provided, swap mode is used instead of rotate. */
    iconClose?: string;
